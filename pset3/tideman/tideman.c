...
// Function used for sorting elements with quicksort
...
// strength of victory is the value the pair's winner has in preferences array
void sort_pairs(void)
{
    // TODO
...
void lock_pairs(void)
{
    ...
    for (int i = 0; i < pair_count; i++)
    {
        ...
        for (int j = 0; j < MAX; j++)
        {
            if (locked[j][pairs[0].winner] == true)
            {
                valid = false;
            }
        }
